...
llm_map = {'gpt_4o' : {'model' : "gpt-4o", 'tools' : []}, 'gpt_4o_web' : {'model' : "gpt-4o", 'tools' : [ { 'type': "web_search_preview" } ]}}

from openai import OpenAI
client = OpenAI(api_key=OPENAI_API_KEY)

text_list = ['politics_1_0', 'politics_2_0']
llm_list = ['gpt_4o', 'gpt_4o_web']
prompt_list = ['mediator_1']
